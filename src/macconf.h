...
*
*  This file contains macintosh-specific defines, types, etc for Think C.
*
...
#define MAX_BITMAP_SIZE 65535L	/* 320 x 200 plus a little */

/*#define TEST_ABORT if (Options & EXITENABLE) if (kbhit()) { Stop_Flag = TRUE;
#define TEST_ABORT
...
/* This gives us ANSI prototyping */
#define PARAMS(x) x
#define volatile

char *malloc();
#define START_DKB_TRACE argc = ccommand(&argv);
